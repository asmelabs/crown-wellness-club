...
function MembershipBannerStat({ stat }: { stat: MembershipBannerStatType }) {
  return (
    <div key={stat.subtitle} className='rounded-2xl border border-border/60 bg-muted/40 px-4 py-4 text-center'>
...
function MembershipBannerStats({ stats }: { stats: MembershipBannerStatType[] }) {
  return (
