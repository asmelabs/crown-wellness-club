...
export const services: ServiceType[] = [
	{
		...
		description:
			"Indulge in curated therapies designed to restore balance, elevate recovery, and renew your energy.",
		tags: ["Signature"],
		image:
	...
	},
	{
		...
		description:
			"State-of-the-art equipment, performance training, and personalized coaching to reach peak potential.",
		tags: ["Performance"],
		image:
	...
	},
	{
		...
		description:
			"A serene water experience featuring vitality pools, hydrotherapy, and restorative immersion.",
		tags: ["Wellness"],
		image:
			"https://images.unsplash.com/photo-1501117716987-c8e1ecb210f9?q=80&w=1400&auto=format&fit=crop",
		icon: "waves",
		stats: [
